...
const BUSINESS_KEYS = new Set([
  ...
  "invalid_category",
  "invalid_format",
  "invalid_sponsoring_level",
  "vivenu_failed",
  "edition_without_vivenu",
  "ticket_type_missing",
  "holder_incomplete",
  "barcode_missing",
  ...
  "invalid_discount",
  "derived_allocation",
  // Vokabularpflege (Migration 0130)
  "usage_unknown",
  "has_children",
  "invalid_key",
  "org_not_found",
  ...
  // Einwilligungen stellvertretend im Verwaltet-Fall (Vorschlag v6_einwilligung_stellvertretend, SPK-074)
  "consent_not_managed",
