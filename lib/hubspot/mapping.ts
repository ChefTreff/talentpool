...
/** HubSpot „CT Company Type“ → Vokabular `organization_type` (Stiftung = `foundation`, Service / Kooperation = `service`; 0059/0060). Unbekannte Werte bleiben leer, die Datenbank setzt dann `corporate`. */
