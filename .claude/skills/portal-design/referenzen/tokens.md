...
| `--ct-hatch-closed` · Utility `bg-hatch-closed` | 135°-Streifen aus `canvas` und `border` | „außerhalb der Öffnungszeit“ im Programm-Board (LEAD-033) — **ohne Text darauf**; die Zeit steht als Text im Spaltenkopf, die Fläche wiederholt sie nur als Form |
