...
-- audit_log) und keine Lese-Grants auf Tabellen ohne Lese-Policy (organization) — behält aber, was Policies tragen (consent_record insert, person update als Spalten-Grant,
...
begin
  ...
  insert into t_res values ('04_auth_reads', 'organization=' || has_table_privilege('authenticated', 'organization', 'select')::text
