...
begin
  ...
  insert into t_res values ('06b_vocab_foundation', (select 'foundation=' || is_vocab_key('organization_type', 'foundation')::text || ' service=' || is_vocab_key('organization_type', 'service')::text || ' initiative=' || is_vocab_key('organization_type', 'initiative')::text));
