...
| HACK-006 | 24.09. | /hackathon (Teilnehmer- und Partner-App) | Feedback von Emilio (Durchführung Hack 2026) aus dem Call mit Konrad am 24.09. → beim Start der Hackathon-Arbeiten aus der Granola-Notiz auslesen und in Einzelpunkte zerlegen: `https://notes.granola.ai/t/8737d8f0-27df-419b-82ca-aeda6db2f31c-008umkv4` | P2 | offen (ruht bis zur Feature-Übersicht, Woche ab 28.09.) | Konrad 24.09. |
| HACK-007 | 24.09. | /hackathon (Bewerbung/Profil) | Portfolio-Links (GitHub, Website, Behance) fehlen → nur im Hackathon erheben, nicht im allgemeinen Teilnehmer-Profil (Feldvorschlag TAL-013, Punkt C3) | P3 | offen (Hackathon ruht) | Konrad 24.09., `docs/talent-felder-vorschlag.md` §5 — übergeben von Talent |
