...
| PROD-007 | 17.09. | /produktion (Regie) | Technik-Angaben der Speaker fehlen im Regieplan → Tech-Rider, Präsentation und Medien je Slot im Regieplan sichtbar (aus SPK-018) | P2 | erfasst | Speaker-Punkt 4 |
