...
| PROD-007 | 17.09. | /produktion (Regie) | Technik-Angaben der Speaker fehlen im Regieplan → Tech-Rider, Präsentation und Medien je Slot im Regieplan sichtbar (aus SPK-018) | P2 | geplant #79 (Spalte „Ansage Speaker“ in der Regie-Tabelle, Migration 0121) | Speaker-Punkt 4 |
