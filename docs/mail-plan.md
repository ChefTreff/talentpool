...
| `shop_order_confirmed` | Partner | `shop_confirm` (Bestellung bestätigt; Positionen, Summe netto, Frist bis zur Verbindlichkeit) | Bestätigende + `primary_ops` | Bestellung × Person je Bestätigung | 0048 |
