...
- [x] **Event-App prüfen:** Conferras-Demo/Angebot einholen und gegen Swapcard bewerten (Frage 86), Entscheidung bis 24.09. — Konrad. — **entschieden 21.09.2026: Swapcard bleibt**, Verbindungen per API jetzt bauen und testen (Arbeitspaket EA, `docs/arbeitsauftrag-welle-6.md`).
