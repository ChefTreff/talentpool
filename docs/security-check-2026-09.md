...
**Stand 25.09. abends: L1–L7 behoben mit Migration 0210 (`v6_port3_stage_leads`, #231).** Externe Stage-Lead-Zugänge sind seitdem erlaubt, nur mit Bühnen-Scope. Offen: Stage-Lead-Schritt in `sicherheit_rollenkonten.sql` (Architektur-Session), Storage-Policies je Rolle, K-14.
