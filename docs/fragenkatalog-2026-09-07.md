...
86. **Event-App-Option erneut prüfen (Konrad, 08.09.):** Swapcard (Vertrag 2027 laut Antwort 10) gegen **Conferras** (conferras.com) als Idee. Kriterien: Import-API für Teilnehmer/Speaker/Sessions/Aussteller (heute Swapcard GraphQL mit unseren IDs), Website-Embed des Programms (Antwort 76), Lead-Scanning für Partner, Gruppen/Rechte je Pass-Typ, Barcode = vivenu-QR, DSGVO/AVV und Datenstandort, Kosten, Migrationsaufwand bis 01.11. **Entscheidung vor Welle 3 (24.09.)**, weil dort der Sync gebaut wird; bis dahin Adapter-Schnittstelle statt Swapcard-spezifischer Logik.
   **Erstsichtung Conferras (08.09., Website):** Progressive Web App ohne Store, komplett White-Label, EU-Hosting, DSGVO-konform, Pay-per-Event ab 89 €, bis 2.500+ Teilnehmende. Stark bei Networking (KI-Matchmaking, 1:1-Meetings, Chat, Push, Sponsor-Banner, Job-Board). **Auf der Website nicht belegt:** Import-API/Webhooks, Ticketing-Anbindung (vivenu), Lead-Scanning für Aussteller, Check-in/Badge, Website-Embed, SSO, Datenexport. Genau diese Punkte tragen heute den Swapcard-Sync (Inventar §6) und die Partner-Leistungen (Lead-Scanning, Aussteller-Profile). **Vor einer Demo klären:** API zum Anlegen von Personen/Sessions/Ausstellern mit unseren IDs, Embed des Programms, Lead-Scanning, Gruppen je Pass-Typ, AVV, Referenzen ab 5.000 Teilnehmenden.

## Antworten — Stand 10.09.2026 abends (Konrad, Welle 3)
**7** ✅ Kontaktrollen final: `primary_ops` (einer, alles), `additional` (alles außer Mitglieder), `signing`, `event_app_member`; Accounting ohne Login = Rechnungs-E-Mail · **14** ✅ Feldliste bestätigt (wird ergänzt), Mail an Bewerber erst nach Zusage, Export v2 · **19** ✅ Secret Shop bevorzugt, Coupon-Fallback · **59** ✅ Strategy-Calls Welle 5 · **79** ✅ vorerst 7 % überall, Finanzamt-Check folgt · **80** ✅ SKU = Item-ID (HubSpot/SevDesk bereits so) · **81** ⏳ mit 79 · **82** ✅ preislose Zusatzleistungen als Produkte ohne Listenpreis · **83** ✅ Platzhalter-SKUs und „Bundle Liste 2026" entfallen · **86** ✅ Swapcard bleibt 2027, Eigenbau/Conferras für 2028 evaluieren · Fristen 2027 und Gate-Benachrichtigung (Slack `#fls27-onboarding` + Deal-Owner) siehe `arbeitsauftrag-welle-3.md` Abschnitt E.
