...
| „Speaker Arrival" / An- und Abreise | `/admin/anreise` und `/speaker-leads/anreise` (`speaker_travel_list`), Filter Tag / Verkehrsmittel / nur mit Shuttle / nur offen, Spalte Shuttle (angefragt/bestätigt, SPK-069) | **vorhanden** | Migration 0098, `v6_catering_anreise_shuttle` | | |
