...
### 14.1 Volunteer-Wiki (Notion-DB `2c017aa69eee8029b469fde07c244467`, „Volunteer Wiki – FUTURE LEADER SUMMIT 2026") — Stand 08.09.2026
- **Typ/Schema:** Notion-Wiki-DB unter FLS26 → Production. Schema vom Partner/Speaker-Wiki kopiert (Kategorie Allgemein/Partner & Messe/Speaker, Status, Ansprechpartner, E-Mail, Messeshop) — **in allen geprüften Seiten leer**. Views „All pages", „Pages I own". Umfang aus Startseite rekonstruiert: **44 verlinkte Artikel + ≥ 9 Unterseiten (≈ 53)**, zuletzt bearbeitet März–Juni 2026. (Zählung per Query nicht möglich, Notion-MCP-Vollversion nötig.)
- **Struktur (Startseite):** Everything you need to know – Volunteering (How to start the Day, Overview Event Program, Emergency Call, Dresscode, Catering & Meals, Crew Lounge) · … – FLS (About ChefTreff, CCH Location & Arrival, Event map, Team-Lead Briefing, Funk/Radio Briefing) · Web-App/Community (Volunteer Web-App, WhatsApp-Gruppen) · **Check-In Hero** (Pre-Scan, Flow Manager, Accreditation Help, Regular Counter, Partner & Exhibitor Counter, Speakers Counter, Support Counter, Entrance Control) · **Stage Management** (je Bühne 2026) · **Speaker Management** (Speakers Care/Runner, Speakers Lounge, Security) · **Guest Relations** (Infopoint, Cloakroom, Production Helpdesk mit Article List/Lending Process/Handover/Add-on Booking List, Marketing Hero) · **Logistics Hero** (Sustainability Station/Warehouse/Field, Construction Help) · **Side Events** (AI Hackathon, Speaker Reception, Future of HR, Party Hero, VC Breakfast) · Masterclasses. DE-Seiten haben englische Zwillings-Unterseiten.
- **Artikel-Muster:** Rollen-Seiten folgen einem festen Template aus farbigen Callouts: TOC → „What is …?" → „Why this matters?" → „Your Mission" (Schritte) → „The Team" (Toggle mit Foto, Namen, WhatsApp-Link). 100–600 Wörter (allgemein), 600–1.500 (Rollen). Überwiegend Englisch, Check-in-/Speaker-Seiten Deutsch mit EN-Zwilling. Medien: Cover, Screenshots (Lageplan, App), Loom, Google-Maps-Embed, Synced Blocks; Bilder als ablaufende Notion-S3-URLs → exportieren.
- **Hart codiert (2026):** Datum 07.–13.04., CCH Halle H, Parktarife, Side-Event-Orte, Uhrzeiten, vivenu-Tickettypen „…2026", Swapcard-Link FLS26, Meal-Token 11–16 Uhr, Crew-Shirt (keine Größenlogik), Airtable-Check-in. **PII:** Team-Lead-Namen mit Fotos, Team-Listen, Vornamen als Eskalationskontakte, WhatsApp-Einladungslinks auf fast jeder Rollen-Seite (keine Telefonnummern/E-Mails in der Stichprobe). Platzhalter („Marketing Hero → ?", leere Toggles, „Englisch Version will follow tomorrow"). **Keine Slush-Reste** in der DB — das Slush-Material liegt nur in „OLD Volunteer Home" (ausschließen).
- **Bewertung:** import-tauglich als Startbestand, **nicht 1:1**: „The Team"-Blöcke und Eskalations-Vornamen durch Rollenbezeichnungen ersetzen (Kontakte dynamisch aus `role_assignment`), alle Termine/Orte/Preise/Tickettypen als Variablen aus Programm/Produktstamm, Platzhalter bereinigen, Medien neu hosten, DE/EN-Zwillinge als Sprachvarianten eines Artikels zusammenführen. Fehlende Metadaten: Rolle/Team, Zielgruppe (alle / Team Leads / Core), Event-Phase (vor Event / Aufbau / Event / Abbau), Sprache, Gültigkeit, verantwortlicher Bereich, Version. Für die Wissensbasis heißt das: `kb_article.audience` bekommt zusätzlich `role[]` und `phase`.

## 16 · Item-Liste 2026 (Airtable „Working List" `appyPbjOKdS9Ypd4O`) — Produkt-Inventar, Stand 08.09.2026

**Anforderung (Konrad, Antwort 78):** Die Item-Liste ist das Produkt-Inventar, gespiegelt in HubSpot (Line-Items) und SevDesk (Positionen). Sie zieht als `product`-Stamm ins Portal (Import in Welle 3).

- **Base (9 Tabellen):** **Item Liste 2026** (186) · Product-Data (Bundles) (34; Stückliste Bundle → Items + Amount, verlinkt in 14 Items) · Bundle Liste 2026 (34; ältere Variante, Gesamtkosten inkonsistent → verwerfen) · Gipfel Partner 2026 (Partner-CRM mit Umsatz je Leistungsart, PII) · Gipfel Investoren 2026, SLUSH Partner, Future of HR – Einladungen, LEO FoHR (Kontaktlisten, PII, kein Bezug) · Logos Gipfel Partner 2026.
- **Schema (42 Felder, 11 Views):** `Item-ID (SKU)` Primärfeld `I-nnnnn` (186 eindeutig) · `Status Import` {Imported} · `Source` Multi-Select {Hubspot, Messe-Shop} · `Category` (16: Standgastronomie, Branding, Mobiliar, Hackathon, Company Tours, Technik, Standflaeche, Infrastruktur – Versorgung & Anschluesse, Specials, Stage Products, Standbau, Nebenkosten, Pflanzen, Tickets, Essentials, Personal) · `Supplier` (Kaefer, ChefTreff, PartyRent, Branding, CCH, Milo, Fetzer, Messebau, Mavolin, Pflanzen Ludwig, CupConcept, Simply Fine) · `Article Name (Displayed)`, `Description`, `Comment (Internal)` · 4 Bildfelder (nur Shop) · Lieferantenlogik `Item-Number/Name/Link (Supplier Logic)` · Preise: `Net EK`, `Brutto EK` (= × 1,19), `Margin` %, `Minimum` (= EK × (1 + Marge)), `Selling Price (Net)`, `Discount Max Range` (abs./%) · `VAT rate (%)` Select mit einziger Option **„7"** · Bestand: `Stock Amount`, `Amount Sold` (nie gepflegt), `Remaining`, `Status` (Formel) · WooCommerce-Exportspalten (`Exhibitor Shop - Item`, `Product Visibility`, `Status` publish, `Stock Tracking`, `Item Order`, `Purchase note`, `Product URL`, `Attribute`). Views je Lieferant (PartyRent, Milo & Mavolin, Käfer & Specials, Branding, Weiteres), All Items, Imported, Picture View.
- **Zahlen:** Source Hubspot 86 · Messe-Shop 75 · leer 25 (24 namenlose Platzhalter-SKUs). Import-Flag: Shop 75/75, HubSpot 34/86. Kategorien: Standgastronomie 31, Branding 22, Mobiliar 21, Hackathon 13, Company Tours 12, Technik 11, Standflaeche 10, Infrastruktur 8, Specials 8, Stage Products 7, Standbau 5, Nebenkosten 4, Pflanzen 3, Tickets 3, Essentials 2, Personal 1. **HubSpot-Pakete netto:** Signature Stand 990 €/qm · Start-Up 2.900 · Intro 5.900 · General 11.900 · Premium 18.900 · Lounge 24.900 · Main Stage Loge 39.900 · Stage 2.900–16.900 · Company Tour Spot 5.900 · Hackathon 7.900–14.900 · Tickets 299. **52 HubSpot-Items ohne Verkaufspreis** (Infrastruktur, Nebenkosten, Branding-Zusätze). Shop: 75/75 mit EK + VK, VK = EK × (1 + Marge) auf 0,10 € gerundet; Margen 20 % (46), 12 % (14), 0 % (5), 25 % (3), Einzelfälle; 7 „auf Anfrage"-Items mit 0 €. Verkaufspreise netto; USt überall „7" (für Mobiliar/Technik unplausibel → vermutlich Shop-Steuerklasse). Keine Einheit (steckt im Namen: „1qm Teppich", „pro m³"). Kontingente: 109 Items mit Stock Amount (General 50, Intro 30, Premium 20, Topic Stage 64, Masterclass 40, Loge 2), Amount Sold nirgends gepflegt. Kein aktiv/inaktiv-Feld.
- **Spiegelung:** **keine HubSpot-Produkt-ID, kein SevDesk-Artikel/Erlöskonto/Kostenstelle** — einziger Schlüssel ist die SKU; `Source` = Zielsystem, `Article Name` = Line-Item-Name. Unterscheidung: Pakete = Hubspot × (Standflaeche, Stage Products, Company Tours, Hackathon, Specials, Tickets) mit VK · Zusatzleistungen = Hubspot × (Infrastruktur, Nebenkosten, Standbau) ohne VK (23 zusätzlich für den Shop markiert) · Shop-Artikel = Messe-Shop + Supplier + EK + Marge + Bild. **Stückliste** (Product-Data): Premium 18 qm = 5× Rückwand, 18× Teppich, 4× Tolix, 1× Rückwand Monitor, Beleuchtung, Strom, 2× Platzhalter; General 9 qm analog (2/9/2/1); Intro 4 qm (1/4/2/1); Start-Up = Gitterbox, Strom, 2× Tolix; Signature = Beleuchtung + Extra-Strom 16 A. **Deliverables** nur als Freitext in `Description` („Dieser Stand inkludiert: …"); was der **Partner** liefern muss (Logo, Speaker-Daten, Grafik, Fristen), existiert nirgends strukturiert.
- **Ableitung `product` (Masterplan v0.1e):** `sku` (PK, aus Item-ID) · `name_de`, `name_en` (neu) · `description_de` · `type` {package, addon, shop_item} (aus Source × Category) · `category` (Enum, getrimmt) · `unit` (neu: qm, m, Stück, Paket) · `net_price`, `purchase_price_net`, `margin`, `vat_rate` (echter Satz, neu erfassen) · `supplier`, `supplier_sku`, `supplier_url` · `stock_total`, `stock_sold` · `active` (neu) · `edition` · `hubspot_product_id`, `sevdesk_article_id`, `revenue_account`, `cost_centre` (neu, per SKU matchen) · Bilder. Zusätzlich `product_component (bundle_sku, component_sku, qty)` aus Product-Data und `deliverable_template` je Produkt (Partner-Pflichten strukturiert). Import-Mapping: Item-ID → sku · Article Name → name_de · Description → description_de · Category → category · Source → type · Selling Price → net_price · Net EK → purchase_price_net · Margin → margin · Supplier* → supplier* · Stock Amount → stock_total · Status publish → active; Formelfelder nicht importieren.
- **Auffälligkeiten:** 24 Platzhalter-SKUs; 25 Namen und 6 Kategorien mit Leerzeichen; 52 HubSpot-Items ohne Preis; Company Tour Spot in 6 Varianten (5 nicht importiert); „Coffee Station" unter Branding, „Main Stage Loge" unter Standbau; `Price (Sum)` in Product-Data als Text „$11,900.00"; Amount Sold nie gepflegt.
- **Referenzdaten:** `docs/referenz/item-liste-2026.csv` (186 Zeilen, 44 Spalten; Produktdaten ohne Personenbezug) als Import-Vorlage für Welle 3.
