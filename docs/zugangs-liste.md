...
| `MAKE_ONBOARDING_WEBHOOK_URL` | make.com → Slack | Gate-Fehler nach `#fls27-onboarding` (Entscheidung 10, make nur als Transport) | make-Szenario „Custom Webhook → Slack“; optional Header `x-webhook-secret` = `MAKE_WEBHOOK_SECRET` prüfen | 3 |
