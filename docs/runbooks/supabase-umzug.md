...
| 11.09.2026 | Architektur-Session | Prüfung für Schritt 16: keine Verweise mehr auf `fsjexlrapilzftwibocu` in Code, Env oder Vercel; Empfehlung an Konrad: im Dashboard pausieren, Löschen frühestens eine Woche später (beides nur durch Konrad). |
| 11.09.2026 | Konrad | Altes Projekt `fsjexlrapilzftwibocu` (Dublin) gelöscht — Umzug damit vollständig abgeschlossen. |
