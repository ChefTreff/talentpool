...
/**
 * Die Startseite des **Summits** (Seitengruppe „Summit 2027", D11, Konrad
 * 24.09.2026). Bis dahin war sie die Startseite des ganzen Portals und hiess
 * „Übersicht"; seit TAL-005 liegt auf `/start` ein allgemeines „Home" für
 * alle Formate, und diese Seite ist der Einstieg in den Summit — Programm,
 * Bewerbungen, später Tickets.
 *
 * Ursprünglich eine **Menüseite**: was kann ich hier tun, und wo fange ich an
 * (Konrad, 22.09.2026).
 *
 ...
 */
export default async function SummitStartPage() {
  await requireUser("/summit");
