...
/**
 * Die Menübeschriftung je Abschnitt — die Schlüssel in `admin.nav` folgen nicht
 * überall dem Abschnittsschlüssel (`partner` heisst dort `partnerCare`).
 * Aufgezählt statt geraten: ein danebenliegender Schlüssel gäbe eine Auswahl
 * mit technischen Namen.
 */
const NAV_JE_ABSCHNITT: Record<string, string> = {
  partner: "partnerCare",
  volunteers: "volunteersWork",
};
